...
public class TimeVerifyWithEexcle {
	...
	static String fileName = System.getProperty("user.dir") +  System.getProperty("file.separator") +
	          ...
	          "NAPLEX Master Syllabus (1).xlsx";
	static String filena = "C:\\Users\\AbRahman\\Desktop\\NAPLEX.xlsx";
	String sheetname = "NAPLEX 2015 Syllabus";
	//*************
    ...
    private static XSSFCell CellDura;
    static int rowNum = 0;
   ...
   /* private excleprac(WebDriver driver){
		this.driver= driver;
	}*/
...
//This method is to write in the Excel cell, Row num and Col num are the parameters
	...
	public static void writeCellData(int ColNum,int RowNum, String Result) throws Exception	{
		try{
			System.out.println("kichuna only check ");
			Row  = ExcelWSheet.getRow(RowNum);
